...
// uint32 user = 1;
inline void GetFriendListRequest::clear_user() {
  user_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::_internal_user() const {
  return user_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::user() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequest.user)
  return _internal_user();
}
inline void GetFriendListRequest::_internal_set_user(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  user_ = value;
}
inline void GetFriendListRequest::set_user(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_user(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequest.user)
}
